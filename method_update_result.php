...
<?php
	...
	$query 	= "UPDATE method SET Method_Process='$mp', Method_Used_for='$mu', Payment_id='$pi'  WHERE Method_Code= $id";
	//echo $query;

	mysqli_query( $connect, $query )
		or die("Can not execute query");

	echo "<h3 style='margin: 0px 60px'>Record updated:</h3><br><p style='margin: 0px 60px'> Method Process = $mp <br> Method Used For = $mu <br> Payment's ID= $pi </p> ";
